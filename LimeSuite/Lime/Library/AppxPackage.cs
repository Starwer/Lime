/* 
 * Credit: Simon Mourier
 * Source: http://stackoverflow.com/questions/32122679/getting-icon-of-modern-windows-app-from-a-desktop-application
 * 
 * Retrieve manifest from the Modern Apps.
 * 
*/
...
namespace Lime
{
    ...
    public static class AppxPackageTry
    {
        ...
        {
            Console.WriteLine("----------------- AppxPackageTry -----------------");
    ...
    public sealed class AppxPackage
    {
        ...
        public static AppxPackage FromProcess(IntPtr hProcess)
        {
            ...
            // Check OS availability: Not available before Window 8, i.e. Version 6.2
