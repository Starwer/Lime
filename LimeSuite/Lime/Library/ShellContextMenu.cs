...
namespace Peter
{
    ...
    public class ShellContextMenu : NativeWindow
    {
        ...
        private void ReleaseAll()
        {
            ...
            if (null != _arrPIDLs)
            {
                if (_arrPIDLsFree) FreePIDLs(_arrPIDLs);
                _arrPIDLs = null;
            }
        }
        #endregion
        ...
        /// Shows the context menu
        /// </summary>
        /// <param name="pidls">PIDLs (should all be in same directory)</param>
        /// <param name="pointScreen">Where to show the menu</param>
        public void ShowContextMenu(IntPtr[] pidls, Point pointScreen)
        {
            // Release all resources first.
            ReleaseAll();
            _arrPIDLsFree = false;
        ...
        private bool _arrPIDLsFree = true;
