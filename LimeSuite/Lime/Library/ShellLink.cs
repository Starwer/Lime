...
* 
*  01-11-2015 - Changed by Sebastien Mouy (Starwer)  
*               Added the "PIDL" Property
*  13-06-2016 - Changed by Sebastien Mouy (Starwer)  
*               Now resolve the environment variables
*  28-01-2018 - Changed by Sebastien Mouy (Starwer)  
*               Enable to set "None" as Hotkey (to remove hotkey)
**************************************************************************/
...
namespace MSjogren.Samples.ShellLink
{
    ...
    private IShellLinkW m_Link;
      ...
      m_Link = (IShellLinkW) new ShellLink();
        ...
        /// <summary>
        /// Gets or sets the pointer to an item identifier list (PIDL) for a Shell link object.
        ...
        public IntPtr PIDL
        {
            get
            {
                ...
                m_Link.GetIDList(out ret);
                return ret;
            }

            set
            {
                m_Link.SetIDList(value);
            }
        }
        ...
        public Keys Hotkey
        {
            ...
            set
            {
                ...
                if ((value & Keys.Modifiers) == 0 && value != Keys.None)
